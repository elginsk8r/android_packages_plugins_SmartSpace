...
public class BcSmartspaceCard extends ConstraintLayout {
        ...
        if (mTextGroup != null) {
            ...
            if (viewGroup2 != null && viewGroup2.getVisibility() != 8) {
                ...
                viewGroup3.setTranslationX(
                        Interpolators.EMPHASIZED.getInterpolation(mDozeAmount)
                                * mSecondaryCardGroup.getWidth()
                                * i2);
                mSecondaryCardGroup.setAlpha(
    ...
    public final void setSubtitle(
        ...
        BcSmartspaceTemplateDataUtils.offsetTextViewForIcon(
                mSubtitleTextView, doubleShadowIconDrawable2, isRtl());
    }
    ...
    public final void setTitle(CharSequence charSequence, CharSequence charSequence2, boolean z) {
        ...
        BcSmartspaceTemplateDataUtils.offsetTextViewForIcon(
                mTitleTextView, doubleShadowIconDrawable2, isRtl());
    }
